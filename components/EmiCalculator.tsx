...
export default function EmiCalculator() {
  ...
  return (
    <div className="my-8 rounded-2xl glass-card p-6 border border-emerald-500/20 shadow-xl bg-slate-900/80">
      <div className="flex items-center gap-3 mb-6">
        <div className="p-3 rounded-xl bg-emerald-500/10 text-emerald-400 border border-emerald-500/30">
          <Calculator className="w-6 h-6" />
        </div>
        <div>
          <h3 className="text-xl font-bold text-slate-100 m-0">Interactive Loan EMI Calculator</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-5">
          ...
          <div>
            <div className="flex justify-between text-sm font-semibold mb-2">
              ...
              <span className="text-emerald-400 font-mono text-base">${amount.toLocaleString()}</span>
            </div>
            <input
              type="range"
              min={1000}
          ...
          <div>
            <div className="flex justify-between text-sm font-semibold mb-2">
              ...
              <span className="text-teal-400 font-mono text-base">{rate}%</span>
            </div>
            <input
              type="range"
              min={5}
          ...
          <div>
            <div className="flex justify-between text-sm font-semibold mb-2">
              ...
              <span className="text-cyan-400 font-mono text-base">{tenureYears} Years ({tenureYears * 12} Mos)</span>
            </div>
            <input
              type="range"
              min={1}
        ...
        <div className="flex flex-col justify-between p-5 rounded-xl bg-slate-950/60 border border-slate-800">
          <div className="text-center py-2">
            <span className="text-xs uppercase font-semibold tracking-wider text-slate-400">Monthly EMI Payment</span>
            <div className="text-4xl font-extrabold text-emerald-400 font-mono my-2">${emi.toLocaleString()}</div>
            <span className="text-xs text-slate-500">Principal + Interest per month</span>
          </div>
